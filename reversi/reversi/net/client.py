...
class RemoteClientConnection:
    ...
    def connect(self) -> None:
        ...
        join_message: dict[str, Any] = {"type": "join", "name": self.name}
        if self.session_token is not None:
            join_message["session_token"] = self.session_token
    ...
    def _reader_loop(self) -> None:
        ...
        while not self._closed.is_set():
            ...
            try:
                ...
                self._messages.put({"type": "disconnect", "message": "Server sent invalid JSON and closed."})
                break
    ...
    def send_move(self, row: int, col: int) -> None:
        self.send({"type": "move", "row": row, "col": col})
    ...
    def send_close_room(self) -> None:
        self.send({"type": "close_room"})
